...
After the cleaning process 12 variables were included in the analysis with 70 observations.
...
The distributions of these variables can be seen in Figures A1--A4 (Section 8.1).
...
|__Age at last ACLR (years)__      |       27 (10)       |    28 (11)     |     25 (8)      | 0.32  | -0.16, 0.80 |    0.187    |
|Unknown                           |          3          |       3        |        0        |       |             |             |
...
![](../figures/distr_age.png)

**Figure A1** Distribution of age in the study population.

![](../figures/distr_sex.png)

**Figure A2** Distribution of sex in the study population, according to the study group.

![](../figures/distr_bmi.png)

**Figure A3** Distribution of BMI in the study population.

![](../figures/distr_fu.png)

**Figure A4** Distritubion of follow up time in the study population.
